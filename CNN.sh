...
g++ -I../CBLAS/include -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"src/loss.d" -MT"src/loss.d" -o "src/loss.o" "src/loss.cpp"
g++ -o "CNNtest" ./src/loss.o ./src/FFNN.o ./src/activation.o ./src/global.o ./src/main.o ./src/read_data.o ./src/predict.o ../CBLAS/lib/cblas_LINUX.a ../BLAS/BLAS-3.6.0/blas_LINUX.a -lgfortran -lpthread
