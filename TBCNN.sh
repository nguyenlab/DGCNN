...
g++ -o "TBCNNtest" ./src/FFNN.o ./src/activation.o ./src/global.o ./src/main.o ./src/read_data.o ./src/predict.o ../CBLAS/lib/cblas_LINUX.a ../BLAS/BLAS-3.6.0/blas_LINUX.a -lgfortran -lpthread
